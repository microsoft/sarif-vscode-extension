[![](https://vsmarketplacebadges.dev/version-short/MS-SarifVSCode.sarif-viewer.png)](https://marketplace.visualstudio.com/items?itemName=MS-SarifVSCode.sarif-viewer)
