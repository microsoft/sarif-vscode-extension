...
export type CommandPanelToExtension = 'load' | 'open' | 'downloadLog' | 'downloadArtifact' | 'closeLog' | 'closeAllLogs' | 'select' | 'selectLog' | 'setState' | 'showPanel' | 'refresh' | 'removeResultFixed';
